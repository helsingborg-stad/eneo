...
<script lang="ts">
  ...
  import ImageGenerationModelsTable from "./ImageGenerationModelsTable.svelte";
...
<Page.Root>
  <Page.Header>
    ...
    <Page.Tabbar>
      ...
      <Page.TabTrigger tab="image_generation_models">{m.image_generation_models()}</Page.TabTrigger>
    </Page.Tabbar>
  </Page.Header>
  <Page.Main>
    ...
    <Page.Tab id="image_generation_models">
      <ImageGenerationModelsTable
        imageGenerationModels={data.models.imageGenerationModels}
        providers={data.providers}
        favoriteProviders={data.favoriteProviders}
      />
    </Page.Tab>
